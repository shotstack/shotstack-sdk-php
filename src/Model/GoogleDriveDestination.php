 ...
 */
class GoogleDriveDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GoogleDriveDestination';
    ...
    {
        $this->setIfExists('provider', $data ?? [], 'google-drive');
