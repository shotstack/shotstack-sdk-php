...
/**
 * ShapeAssetLine Class Doc Comment
 *
 * @category Class
 ...
 */
class ShapeAssetLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShapeAsset_line';
    ...
    */
     ...
     * Sets length
     *
     * @param int $length Set the length of the line shape in pixels.
     *
     * @return self
     */
     ...
     * Sets thickness
     *
     * @param int $thickness Set the thickness of the line in pixels.
     *
     * @return self
     */
