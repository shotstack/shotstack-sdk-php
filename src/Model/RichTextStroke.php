...
/**
 * RichTextStroke Class Doc Comment
 *
 * @category Class
 ...
 */
class RichTextStroke implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichTextStroke';
    ...
    */
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling RichTextStroke., must be bigger than or equal to 0.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling RichTextStroke., must conform to the pattern /^#[A-Fa-f0-9]{6}$/.");
        }
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichTextStroke., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichTextStroke., must be bigger than or equal to 0.');
        }
