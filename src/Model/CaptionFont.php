 ...
 */
class CaptionFont implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptionFont';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('stroke_width', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets stroke
     *
     * @param string|null $stroke The stroke color of the font using hexadecimal color notation.
     *
     * @return self
     */
     ...
     * Sets stroke_width
     *
     * @param float|null $stroke_width The width of the stroke in pixels.
     *
     * @return self
     */
    public function setStrokeWidth($stroke_width)
    {
        if (is_null($stroke_width)) {
            throw new \InvalidArgumentException('non-nullable stroke_width cannot be null');
        }
