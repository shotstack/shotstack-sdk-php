...
/**
 * DolbyEnhancementOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class DolbyEnhancementOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DolbyEnhancementOptions';
    ...
    public const PRESET_CONFERENCE = 'conference';
    public const PRESET_INTERVIEW = 'interview';
    public const PRESET_LECTURE = 'lecture';
    public const PRESET_MEETING = 'meeting';
    public const PRESET_MOBILE_PHONE = 'mobile_phone';
    public const PRESET_MUSIC = 'music';
    public const PRESET_PODCAST = 'podcast';
    public const PRESET_STUDIO = 'studio';
    public const PRESET_VOICE_OVER = 'voice_over';
    ...
    {
        return [
            self::PRESET_CONFERENCE,
            self::PRESET_INTERVIEW,
            self::PRESET_LECTURE,
            self::PRESET_MEETING,
            self::PRESET_MOBILE_PHONE,
            self::PRESET_MUSIC,
            self::PRESET_PODCAST,
            self::PRESET_STUDIO,
            self::PRESET_VOICE_OVER,
        ];
    }
