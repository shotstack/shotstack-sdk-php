...
/**
 * RichTextBackground Class Doc Comment
 *
 * @category Class
 ...
 */
class RichTextBackground implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichTextBackground';
    ...
    */
    ...
    public function setColor($color)
    {
        ...
        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling RichTextBackground., must conform to the pattern /^#[A-Fa-f0-9]{6}$/.");
        }
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichTextBackground., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichTextBackground., must be bigger than or equal to 0.');
        }
     ...
     * Sets border_radius
     *
     * @param float|null $border_radius The border radius of the background box in pixels. Must be 0 or greater.
     *
     * @return self
     */
    public function setBorderRadius($border_radius)
    {
        ...
        if (($border_radius < 0)) {
            throw new \InvalidArgumentException('invalid value for $border_radius when calling RichTextBackground., must be bigger than or equal to 0.');
        }
