...
/**
 * CaptionMargin Class Doc Comment
 *
 * @category Class
 ...
 */
class CaptionMargin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptionMargin';
    ...
    */
     ...
     * Sets top
     *
     * @param float|null $top The margin above the text. Pushes captions down the screen.
     *
     * @return self
     */
     ...
     * Sets left
     *
     * @param float|null $left The margin to the left of the text. Pushes captions to the right.
     *
     * @return self
     */
     ...
     * Sets right
     *
     * @param float|null $right The margin to the right of the text. Pushes captions to the left.
     *
     * @return self
     */
