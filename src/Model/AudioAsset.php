    ...
    */
    ...
    public function setMusicLengthMs($music_length_ms)
    {
        ...
        if (($music_length_ms > 600000)) {
            throw new \InvalidArgumentException('invalid value for $music_length_ms when calling AudioAsset., must be smaller than or equal to 600000.');
        }
        if (($music_length_ms < 3000)) {
            throw new \InvalidArgumentException('invalid value for $music_length_ms when calling AudioAsset., must be bigger than or equal to 3000.');
        }
    ...
    public function setCompositionPlan($composition_plan)
    {
        ...
        if ((mb_strlen($composition_plan) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $composition_plan when calling AudioAsset., must be smaller than or equal to 4000.');
        }
