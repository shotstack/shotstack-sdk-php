...
/**
 * DestinationsAnyOf2Options Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinationsAnyOf2Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destinations_anyOf_2_options';
    ...
    */
     ...
     * Sets account_name
     *
     * @param string $account_name The Azure Storage account name.
     *
     * @return self
     */
     ...
     * Sets container
     *
     * @param string $container The Blob container name. The container must exist in the Azure Storage account before files can be sent.
     *
     * @return self
     */
     ...
     * Sets prefix
     *
     * @param string|null $prefix A virtual directory prefix for the blob being sent, i.e. `videos` or `customerId/videos`.
     *
     * @return self
     */
