...
class Transcription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets format
     *
     * @param string|null $format The output format of the transcription file. The following formats are available: <ul>   <li>`srt` - SRT captions format</li>   <li>`vtt` - VTT captions format</li> </ul>
     *
     * @return self
     */
