...
class ShotstackGeneratedAssetOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShotstackGeneratedAssetOptions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('guidance_scale', $data ?? [], 1.8);
        $this->setIfExists('motion', $data ?? [], 127);
    ...
    */
     ...
     * Sets image_url
     *
     * @param string $image_url The URL of the image to convert to video. The URL must be publicly accessible or include credentials. The image dimensions must exactly match one of the following: 1024px x 576px, 576px x 1024px or 768px x 768px.
     *
     * @return self
     */
     ...
     * Sets guidance_scale
     *
     * @param float|null $guidance_scale The guidance scale determines how closely the generated video will match the image. Lower numbers allow for more creative freedom. A number between 0 and 10.
     *
     * @return self
     */
     ...
     * Sets motion
     *
     * @param int|null $motion The amount of motion in the video. A number between 1 and 255.
     *
     * @return self
     */
    ...
    {
        if (is_null($motion)) {
            throw new \InvalidArgumentException('non-nullable motion cannot be null');
        }
