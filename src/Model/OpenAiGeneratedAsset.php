...
/**
 * OpenAiGeneratedAsset Class Doc Comment
 *
 * @category Class
 ...
 */
class OpenAiGeneratedAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenAiGeneratedAsset';
    ...
    protected static $openAPITypes = [
        'provider' => 'string',
        'options' => '\Shotstack\Client\Model\OpenAiGeneratedAssetOptions'
    ];
    ...
    {
        $this->setIfExists('provider', $data ?? [], 'openai');
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The name of the provider - set to `openai` for OpenAI.
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \Shotstack\Client\Model\OpenAiGeneratedAssetOptions
     */
     ...
     * Sets options
     *
     * @param \Shotstack\Client\Model\OpenAiGeneratedAssetOptions $options options
     *
     * @return self
     */
