...
/**
 * RichCaptionActiveStroke Class Doc Comment
 *
 * @category Class
 ...
 */
class RichCaptionActiveStroke implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichCaptionActive_stroke';
    ...
    */
     ...
     * Sets width
     *
     * @param float|null $width The width of the stroke in pixels. Must be 0 or greater.
     *
     * @return self
     */
    public function setWidth($width)
    {
        ...
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling RichCaptionActiveStroke., must be bigger than or equal to 0.');
        }
     ...
     * Sets color
     *
     * @param string|null $color The stroke color using hexadecimal color notation.
     *
     * @return self
     */
    public function setColor($color)
    {
        ...
        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling RichCaptionActiveStroke., must conform to the pattern /^#[A-Fa-f0-9]{6}$/.");
        }
     ...
     * Sets opacity
     *
     * @param float|null $opacity The opacity of the stroke where 1 is opaque and 0 is transparent.
     *
     * @return self
     */
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichCaptionActiveStroke., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichCaptionActiveStroke., must be bigger than or equal to 0.');
        }
