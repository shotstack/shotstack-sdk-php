...
class MergeField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('find', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($find)) {
            throw new \InvalidArgumentException('non-nullable find cannot be null');
        }
    ...
    {
        if (is_null($replace)) {
            array_push($this->openAPINullablesSetToNull, 'replace');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('replace', $nullablesSetToNull);
            if ($index !== FALSE) {
