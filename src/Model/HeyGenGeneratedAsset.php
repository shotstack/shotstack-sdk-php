...
/**
 * HeyGenGeneratedAsset Class Doc Comment
 *
 * @category Class
 ...
 */
class HeyGenGeneratedAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HeyGenGeneratedAsset';
    ...
    protected static $openAPITypes = [
        'provider' => 'string',
        'options' => '\Shotstack\Client\Model\HeyGenGeneratedAssetOptions'
    ];
    ...
    {
        $this->setIfExists('provider', $data ?? [], 'heygen');
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The name of the provider - set to `heygen` for HeyGen.
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \Shotstack\Client\Model\HeyGenGeneratedAssetOptions
     */
     ...
     * Sets options
     *
     * @param \Shotstack\Client\Model\HeyGenGeneratedAssetOptions $options options
     *
     * @return self
     */
