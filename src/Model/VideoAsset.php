...
class VideoAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets prompt
     *
     * @param string|null $prompt A text prompt to generate the video from. When set without `src`, the engine generates a video and fills `src` automatically. Optionally pair with `seed` for image-to-video. Use `model` to choose the generator.
     *
     * @return self
     */
     ...
     * Sets seed
     *
     * @param string|null $seed Seed image URL for image-to-video generation. The image is used as the starting frame; `prompt` describes the motion. Has no effect unless `prompt` is set.
     *
     * @return self
     */
