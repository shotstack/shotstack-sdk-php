...
/**
 * DestinationsAnyOf2 Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinationsAnyOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destinations_anyOf_2';
    ...
    {
        $this->setIfExists('provider', $data ?? [], 'azure-blob-storage');
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The destination to send assets to - set to `azure-blob-storage` for Azure Blob Storage.
     *
     * @return self
     */
