 ...
 */
class DestinationsAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destinations_anyOf';
    ...
    protected static $openAPITypes = [
        'provider' => 'string',
        'options' => '\ShotstackClient\Model\DestinationsAnyOfOptions'
    ];
    ...
    {
        $this->setIfExists('provider', $data ?? [], 'tiktok');
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The destination to send video to - set to `tiktok` for TikTok.
     *
     * @return self
     */
