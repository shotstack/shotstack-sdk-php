...
class S3Destination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'provider' => 'string',
        'options' => '\ShotstackClient\Model\S3DestinationOptions'
    ];
    ...
    {
        $this->setIfExists('provider', $data ?? [], 's3');
    ...
    */
     ...
     * Gets options
     *
     * @return \ShotstackClient\Model\S3DestinationOptions|null
     */
     ...
     * Sets options
     *
     * @param \ShotstackClient\Model\S3DestinationOptions|null $options options
     *
     * @return self
     */
