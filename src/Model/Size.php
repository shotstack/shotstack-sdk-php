...
class Size implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling Size., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling Size., must be bigger than or equal to 1.');
        }
