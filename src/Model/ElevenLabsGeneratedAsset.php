...
/**
 * ElevenLabsGeneratedAsset Class Doc Comment
 *
 * @category Class
 ...
 */
class ElevenLabsGeneratedAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ElevenLabsGeneratedAsset';
    ...
    protected static $openAPITypes = [
        'provider' => 'string',
        'options' => '\Shotstack\Client\Model\ElevenLabsGeneratedAssetOptions'
    ];
    ...
    {
        $this->setIfExists('provider', $data ?? [], 'elevenlabs');
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider The name of the provider - set to `elevenlabs` for ElevenLabs.
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \Shotstack\Client\Model\ElevenLabsGeneratedAssetOptions
     */
     ...
     * Sets options
     *
     * @param \Shotstack\Client\Model\ElevenLabsGeneratedAssetOptions $options options
     *
     * @return self
     */
