 ...
 */
class GoogleCloudStorageDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GoogleCloudStorageDestination';
