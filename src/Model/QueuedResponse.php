 ...
 *
 * @category Class
 * @description The response received after a [render request](#render-video) is submitted. The render task is queued for rendering and a unique render id is returned.
 * @package  Shotstack\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class QueuedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
