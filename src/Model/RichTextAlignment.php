...
/**
 * RichTextAlignment Class Doc Comment
 *
 * @category Class
 ...
 */
class RichTextAlignment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichTextAlignment';
    ...
    public const VERTICAL_MIDDLE = 'middle';
    ...
    {
        $this->setIfExists('horizontal', $data ?? [], 'center');
        $this->setIfExists('vertical', $data ?? [], 'middle');
    }
    ...
    */
     ...
     * Sets horizontal
     *
     * @param string|null $horizontal The horizontal alignment of the text.
     *
     * @return self
     */
     ...
     * Sets vertical
     *
     * @param string|null $vertical The vertical alignment of the text within the bounding box.
     *
     * @return self
     */
