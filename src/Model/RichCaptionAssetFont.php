...
/**
 * RichCaptionAssetFont Class Doc Comment
 *
 * @category Class
 ...
 */
class RichCaptionAssetFont implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichCaptionAsset_font';
    ...
    */
     ...
     * Sets family
     *
     * @param string|null $family The font family name. This must be the Family name embedded in the font, i.e. \"Roboto\".
     *
     * @return self
     */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 500)) {
            throw new \InvalidArgumentException('invalid value for $size when calling RichCaptionAssetFont., must be smaller than or equal to 500.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling RichCaptionAssetFont., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling RichCaptionAssetFont., must conform to the pattern /^#[A-Fa-f0-9]{6}$/.");
        }
    ...
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichCaptionAssetFont., must be smaller than or equal to 1.');
        }
        if (($opacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling RichCaptionAssetFont., must be bigger than or equal to 0.');
        }
    ...
    public function setBackground($background)
    {
        ...
        if ((!preg_match("/^#[A-Fa-f0-9]{6}$/", ObjectSerializer::toString($background)))) {
            throw new \InvalidArgumentException("invalid value for \$background when calling RichCaptionAssetFont., must conform to the pattern /^#[A-Fa-f0-9]{6}$/.");
        }
