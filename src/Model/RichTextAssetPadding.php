...
/**
 * RichTextAssetPadding Class Doc Comment
 *
 * @category Class
 ...
 */
class RichTextAssetPadding implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RichTextAsset_padding';
    ...
    */
    ...
    public function setTop($top)
    {
        ...
        if (($top < 0)) {
            throw new \InvalidArgumentException('invalid value for $top when calling RichTextAssetPadding., must be bigger than or equal to 0.');
        }
    ...
    public function setRight($right)
    {
        ...
        if (($right < 0)) {
            throw new \InvalidArgumentException('invalid value for $right when calling RichTextAssetPadding., must be bigger than or equal to 0.');
        }
    ...
    public function setBottom($bottom)
    {
        ...
        if (($bottom < 0)) {
            throw new \InvalidArgumentException('invalid value for $bottom when calling RichTextAssetPadding., must be bigger than or equal to 0.');
        }
    ...
    public function setLeft($left)
    {
        ...
        if (($left < 0)) {
            throw new \InvalidArgumentException('invalid value for $left when calling RichTextAssetPadding., must be bigger than or equal to 0.');
        }
